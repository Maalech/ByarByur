    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        waktubtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Tpicker = new TimePickerDialog(com.byarbyur.myapplication.ReservationActivity.this,
        ...
        tanggalbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // date picker dialog
                Dpicker = new DatePickerDialog(com.byarbyur.myapplication.ReservationActivity.this,
        ...
        pesanbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ProgressDialog progressDialog = new ProgressDialog(com.byarbyur.myapplication.ReservationActivity.this);
