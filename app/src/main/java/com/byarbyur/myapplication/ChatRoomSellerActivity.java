...
public class ChatRoomSellerActivity extends AppCompatActivity {
    ...
    private void getChatRoomSeller() {
    ...
    ChatRoomsAdapter.OnChatRoomClickListener listener = new ChatRoomsAdapter.OnChatRoomClickListener() {
        ...
        public void onClick(ChatRoom chatRoom) {
            Intent intent = new Intent(ChatRoomSellerActivity.this, ChatActivity.class);
            intent.putExtra(ChatRoomSellerActivity.CHAT_ROOM_ID, chatRoom.getId());
            intent.putExtra(ChatRoomSellerActivity.CHAT_ROOM_BUYER_ID, chatRoom.getId_user());
            intent.putExtra(ChatRoomSellerActivity.CHAT_ROOM_SELLER_ID, chatRoom.getId_usaha());
