    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.collection("pesan").document(id).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()) {
                    ...
                    db.collection("users").document(idUsaha).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        @SuppressLint("SetTextI18n")
                        @Override
                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                            if(documentSnapshot.exists()) {
        ...
        batalbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final ProgressDialog progressDialog = new ProgressDialog(com.byarbyur.myapplication.ReservationDetailActivity.this);
                ...
                db.collection("history").document(id).set(file).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        db.collection("pesan").document(id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Toast.makeText(com.byarbyur.myapplication.ReservationDetailActivity.this, "Pesanan Dibatalkan", Toast.LENGTH_SHORT).show();
                                finish();
                            }
