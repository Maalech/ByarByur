...
public class ManageBusinessActivity extends AppCompatActivity implements iFireStoreLoadDone {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_page = FirebaseFirestore.getInstance().collection("seller").document(userId).collection("image");
